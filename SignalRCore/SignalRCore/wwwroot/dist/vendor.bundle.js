...
var Errors_TimeoutError = /** @class */ (function (_super) {
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/ILogger.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
 ...
 */
var HttpClient_HttpClient = /** @class */ (function () {
    function HttpClient() {
    }
...
var HttpClient_DefaultHttpClient = /** @class */ (function (_super) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            xhr.onload = function () {
                ...
                if (xhr.status >= 200 && xhr.status < 300) {
                    ...
                    reject(new Errors_HttpError(xhr.statusText, xhr.status));
                }
            };
            ...
            xhr.ontimeout = function () {
                ...
                reject(new Errors_TimeoutError());
            };
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/HandshakeProtocol.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.

var HandshakeProtocol_HandshakeProtocol = /** @class */ (function () {
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/Loggers.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
// CONCATENATED MODULE: ./node_modules/@aspnet/signalr/dist/esm/Utils.js
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
function createLogger(logger) {
    if (logger === undefined) {
        return new Utils_ConsoleLogger(LogLevel.Information);
    }
    if (logger === null) {
    ...
    return new Utils_ConsoleLogger(logger);
}
...
var Utils_ConsoleLogger = /** @class */ (function () {
...
var HubConnection_HubConnection = /** @class */ (function () {
    function HubConnection(connection, logger, protocol) {
        ...
        this.handshakeProtocol = new HandshakeProtocol_HandshakeProtocol();
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (response.statusCode !== 200) {
                            ...
                            closeError = new Errors_HttpError(response.statusText, response.statusCode);
                            this.running = false;
                        }
                        else {
                            this.running = true;
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        if (!this.running) {
                            ...
                            if (e_1 instanceof Errors_TimeoutError) {
...
var HttpConnection_HttpConnection = /** @class */ (function () {
    function HttpConnection(url, options) {
        ...
        this.httpClient = options.httpClient || new HttpClient_DefaultHttpClient(this.logger);
    ...
    HttpConnection.prototype.constructTransport = function (transport) {
        switch (transport) {
            case HttpTransportType.WebSockets:
                return new WebSocketTransport_WebSocketTransport(this.accessTokenFactory, this.logger, this.options.logMessageContent);
            case HttpTransportType.ServerSentEvents:
                return new ServerSentEventsTransport_ServerSentEventsTransport(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent);
            case HttpTransportType.LongPolling:
                return new LongPollingTransport_LongPollingTransport(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent);
            default:
...
var HubConnectionBuilder_HubConnectionBuilder = /** @class */ (function () {
    ...
    HubConnectionBuilder.prototype.configureLogging = function (logging) {
        ...
        if (isLogger(logging)) {
            ...
            this.logger = new Utils_ConsoleLogger(logging);
        }
        return this;
    };
    ...
    HubConnectionBuilder.prototype.build = function () {
        ...
        return HubConnection_HubConnection.create(connection, this.logger || NullLogger.instance, this.protocol || new JsonHubProtocol_JsonHubProtocol());
    };
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "HttpError", function() { return Errors_HttpError; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "TimeoutError", function() { return Errors_TimeoutError; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "DefaultHttpClient", function() { return HttpClient_DefaultHttpClient; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "HttpClient", function() { return HttpClient_HttpClient; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "HttpResponse", function() { return HttpResponse; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "HubConnection", function() { return HubConnection_HubConnection; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "HubConnectionBuilder", function() { return HubConnectionBuilder_HubConnectionBuilder; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "MessageType", function() { return MessageType; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "LogLevel", function() { return LogLevel; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "HttpTransportType", function() { return HttpTransportType; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "TransferFormat", function() { return TransferFormat; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "NullLogger", function() { return NullLogger; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "JsonHubProtocol", function() { return JsonHubProtocol_JsonHubProtocol; });
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
